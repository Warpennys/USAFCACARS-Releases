...
- Added a dedicated cockpit-style Dark/Light switch to Pilot Social, synchronized with the website theme preference, plus a purpose-built illuminated steel-blue treatment for Social feeds, profile rails, cards, forms, menus, dialogs, and settings while retaining dark media viewers for accurate image and video contrast.
