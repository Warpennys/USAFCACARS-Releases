...
- Added a compact expandable Network composer: the message editor and posting options stay concealed until the transmission field is selected, validation content reopens safely, and the editor grows with typed content before switching to an internal scrollbar at a monitor-aware maximum height.
