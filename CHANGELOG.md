...
- Restyled the existing phpVMS left navigation in its original sidebar template and CSS with recessed blue-black instrument buttons, blood-red active/open states, cyan icon accents, refined nested navigation, matching pilot and Crew Mail panels, a separate service-years card, and the original borderless rank presentation with a centered silver-first service-star configuration, keyboard focus treatment, hover-revealed blood-red scrolling, and proportional full/mini-sidebar layouts without changing the menu hierarchy or destinations.
