...
- Added a compact directly editable Network composer: the visible transmission field is the real text area, expands in place while the pilot types, and reveals its posting controls beneath it. A dedicated settings gear opens or closes those controls, while the media and emoji shortcuts open their matching option directly.
